...
% in this case)
tpts = [0:1e-3:2];    % A total time of 2 seconds being stepped by 10ms
...
pt_object = @PointObject;
pt_args = {[], 0.01};    % Only one argument has to be passed into the constructor,
